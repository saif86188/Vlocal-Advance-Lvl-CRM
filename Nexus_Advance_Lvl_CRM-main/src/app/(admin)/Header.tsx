        ...
        <div className={`absolute right-0 top-0 bottom-0 w-[85%] sm:w-[380px] bg-neutral-900 rounded-tl-[32px] sm:rounded-l-[32px] shadow-2xl border-l border-t border-white/10 transition-all duration-300 flex flex-col overflow-hidden ${
          ...
          <div className="p-6 border-t border-white/5 bg-black/20 shrink-0">
            <button 
              ...
              className="w-full py-4 rounded-2xl bg-[var(--accent)] hover:bg-[#e0a92b] text-neutral-900 font-bold text-xs uppercase tracking-widest shadow-md transition-all active:scale-95 cursor-pointer"
            >
              Sign Out
            </button>
          </div>
          ...
          <div className="bg-white border border-neutral-200 rounded-[32px] w-full max-w-[400px] shadow-2xl p-6 relative z-10 text-center space-y-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button 
                ...
                className="flex-1 py-3 bg-neutral-950 hover:bg-black text-white rounded-xl font-bold text-xs uppercase tracking-widest cursor-pointer transition shadow-lg"
              >
                Log Out
              </button>
            </div>
